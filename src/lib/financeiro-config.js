import {
  ...
  TrendingUp, FileUp, ShieldCheck, Network, Receipt, History,
} from "lucide-react";
...
export const FINANCEIRO_REAL_LIST = [
  ...
  { slug: "contas-bancarias", title: "Contas Bancárias", icon: Building2, descricao: "Cadastro de contas e saldos." },
