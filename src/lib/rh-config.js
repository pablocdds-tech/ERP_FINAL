...
export const RH_GRUPOS = [
  ...
  },
  {
    ...
    itens: [
      ...
      item({ tipo: "configuracao-ponto", nome: "Banco de Horas", descricao: "Limites, validade e compensação.", icon: Timer, link: "/admin/pessoas/configuracao-ponto" }),
      item({ tipo: "configuracao-ponto", nome: "Regras de Hora Extra", descricao: "Percentuais e limites diários.", icon: Sun, link: "/admin/pessoas/configuracao-ponto" }),
      item({ tipo: "configuracao-ponto", nome: "Adicional Noturno", descricao: "Faixa, percentual e hora reduzida.", icon: Moon, link: "/admin/pessoas/configuracao-ponto" }),
      item({ tipo: "configuracao-ponto", nome: "Regras de Intervalo", descricao: "Mínimo, obrigatório e alertas.", icon: Coffee, link: "/admin/pessoas/configuracao-ponto" }),
