...
export const RH_GRUPOS = [
  {
    ...
    icon: BarChart3,
    itens: [
      item({ tipo: "indicadores", nome: "Painel de Indicadores", descricao: "Cards e gráficos do ponto.", icon: BarChart3 }),
    ],
  },
  {
    id: "cadastros",
  ...
  },
  {
    ...
    itens: [
      ...
      item({ tipo: "justificativas", nome: "Justificativas e Atestados", descricao: "Atestados, abonos e documentos.", icon: FilePlus2 }),
      item({ tipo: "folgas", nome: "Calendário de Folgas", descricao: "Folgas, férias e ausências.", icon: CalendarDays }),
      ...
      item({ tipo: "banco-horas-gestao", nome: "Saldo de Banco de Horas", descricao: "Saldos, compensações e validades por colaborador.", icon: Timer }),
  ...
  },
  {
    ...
    icon: FileBarChart,
    itens: [
      item({ tipo: "rel-cartao-ponto", nome: "Cartão de Ponto", descricao: "Cartão individual por período.", icon: FileText }),
      ...
      item({ tipo: "rel-faltas-atrasos", nome: "Faltas e Atrasos", descricao: "Atrasos e ausências do período.", icon: AlertTriangle }),
      item({ tipo: "rel-horas-extras", nome: "Horas Extras", descricao: "HE 50%, 100% e domingos.", icon: Sun }),
      ...
      item({ tipo: "rel-totalizadores-folha", nome: "Totalizadores para Folha", descricao: "Resumo por colaborador para a folha.", icon: FileSpreadsheet }),
