...
export const PONTO_PARAMS = {
  ...
  "ponto.kiosk.pin_fallback_permitido": {
    categoria: "operacional",
    descricao: "Permitir uso do PIN como alternativa quando a facial falhar.",
    default: "true",
    tipo: "bool",
    label: "PIN fallback permitido",
    grupo: "kiosk",
  },
  "ponto.kiosk.exigir_foto": {
    categoria: "operacional",
    descricao: "Exigir captura de foto (selfie) em toda batida pelo Kiosk, mesmo via PIN.",
    default: "true",
    tipo: "bool",
    label: "Exigir foto no Kiosk",
    grupo: "kiosk",
  },
  "ponto.kiosk.exigir_facial_aprovada": {
    categoria: "operacional",
    descricao: "Bloquear batida de colaborador sem cadastro facial aprovado.",
    default: "false",
    tipo: "bool",
    label: "Exigir facial aprovada",
    grupo: "kiosk",
  },
  "ponto.kiosk.modo_debug": {
    categoria: "operacional",
    descricao: "Exibe informações técnicas extras na tela do Kiosk (apenas para diagnóstico).",
    default: "false",
    tipo: "bool",
    label: "Modo debug",
    grupo: "kiosk",
  ...
  // Banco de Horas
  "ponto.banco_horas.usa": {
    categoria: "operacional",
    descricao: "A empresa utiliza banco de horas.",
    default: "false",
    tipo: "bool",
    label: "Usa banco de horas",
    grupo: "banco_horas",
  },
  "ponto.banco_horas.limite_positivo_min": {
    categoria: "operacional",
    descricao: "Limite máximo de saldo positivo em minutos.",
    default: "2400",
    tipo: "number",
    label: "Limite positivo (min)",
    grupo: "banco_horas",
  },
  "ponto.banco_horas.limite_negativo_min": {
    categoria: "operacional",
    descricao: "Limite máximo de saldo negativo em minutos.",
    default: "1200",
    tipo: "number",
    label: "Limite negativo (min)",
    grupo: "banco_horas",
  },
  "ponto.banco_horas.validade_dias": {
    categoria: "operacional",
    descricao: "Validade das horas em dias (0 = sem validade).",
    default: "180",
    tipo: "number",
    label: "Validade (dias)",
    grupo: "banco_horas",
  },
  "ponto.banco_horas.permite_compensacao": {
    categoria: "operacional",
    descricao: "Permite compensação de horas (folga, saída antecipada, etc.).",
    default: "true",
    tipo: "bool",
    label: "Permite compensação",
    grupo: "banco_horas",
  },
  "ponto.banco_horas.exige_aprovacao": {
    categoria: "operacional",
    descricao: "Compensações precisam de aprovação do gestor.",
    default: "true",
    tipo: "bool",
  ...
  // Hora Extra
  "ponto.hora_extra.percentual_dia_normal": {
    categoria: "operacional",
    descricao: "Percentual adicional de hora extra em dia normal (%).",
    default: "50",
    tipo: "number",
    label: "% dia normal",
    grupo: "hora_extra",
  },
  "ponto.hora_extra.percentual_domingo_feriado": {
    categoria: "operacional",
    descricao: "Percentual adicional de hora extra em domingo/feriado (%).",
    default: "100",
    tipo: "number",
    label: "% domingo/feriado",
    grupo: "hora_extra",
  },
  "ponto.hora_extra.limite_diario_min": {
    categoria: "operacional",
    descricao: "Limite máximo de hora extra por dia em minutos (legal: 120).",
    default: "120",
    tipo: "number",
    label: "Limite diário (min)",
    grupo: "hora_extra",
  },
  "ponto.hora_extra.exige_aprovacao": {
    categoria: "operacional",
    descricao: "Hora extra precisa de aprovação prévia/posterior do gestor.",
    default: "true",
    tipo: "bool",
    label: "Exige aprovação",
    grupo: "hora_extra",
  ...
  // Adicional Noturno
  "ponto.noturno.hora_inicio": {
    categoria: "operacional",
    descricao: "Início da faixa noturna (HH:MM). Padrão CLT urbana: 22:00.",
    default: "22:00",
    tipo: "string",
    label: "Início faixa noturna",
    grupo: "noturno",
  },
  "ponto.noturno.hora_fim": {
    categoria: "operacional",
    descricao: "Fim da faixa noturna (HH:MM). Padrão CLT urbana: 05:00.",
    default: "05:00",
    tipo: "string",
    label: "Fim faixa noturna",
    grupo: "noturno",
  },
  "ponto.noturno.percentual": {
    categoria: "operacional",
    descricao: "Percentual de adicional noturno (%). Padrão CLT urbana: 20.",
    default: "20",
    tipo: "number",
    label: "% adicional noturno",
    grupo: "noturno",
  },
  "ponto.noturno.usa_hora_reduzida": {
    categoria: "operacional",
    descricao: "Aplica hora noturna reduzida (52'30\" = 1h ficta) — padrão urbano CLT.",
    default: "true",
    tipo: "bool",
    label: "Usa hora noturna reduzida",
    grupo: "noturno",
  },

  // Intervalos
  "ponto.intervalo.minimo_min": {
    categoria: "operacional",
    descricao: "Intervalo mínimo permitido em minutos.",
    default: "15",
    tipo: "number",
    label: "Intervalo mínimo (min)",
    grupo: "intervalo",
  },
  "ponto.intervalo.obrigatorio_min": {
    categoria: "operacional",
    descricao: "Intervalo obrigatório a partir de jornadas mais longas (CLT >6h = 60min).",
    default: "60",
    tipo: "number",
    label: "Intervalo obrigatório (min)",
    grupo: "intervalo",
  },
  "ponto.intervalo.alertar_nao_realizado": {
    categoria: "operacional",
    descricao: "Alertar gestor quando o colaborador não registrar o intervalo.",
    default: "true",
    tipo: "bool",
    label: "Alertar intervalo não realizado",
    grupo: "intervalo",
  },
  "ponto.intervalo.pausa_descanso_min": {
    categoria: "operacional",
    descricao: "Duração padrão da pausa de descanso (cafezinho), em minutos.",
    default: "10",
    tipo: "number",
    label: "Pausa de descanso (min)",
    grupo: "intervalo",
  },
};
