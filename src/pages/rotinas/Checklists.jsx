...
const empty = () => ({ titulo: "", descricao: "", frequencia: "diaria", itens: [], ativo: true, gera_ocorrencia: true });
...
export default function Checklists() {
  ...
  return (
    <PageShell title="Checklists" description="Modelos de checklist. Itens não conformes podem gerar ocorrências automáticas."
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 flex items-center gap-2">
              <input type="checkbox" id="gera_oc" checked={data.gera_ocorrencia !== false}
                onChange={(e) => setData({ ...data, gera_ocorrencia: e.target.checked })} />
              <label htmlFor="gera_oc" className="text-xs">Gerar ocorrência automaticamente para itens não conformes</label>
            </div>
